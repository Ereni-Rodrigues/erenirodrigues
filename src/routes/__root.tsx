...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ereni Rodrigues - Terapeuta de Reprocessamento Generativo" },
      {
        name: "description",
        content:
          "Terapia online de Reprocessamento Generativo (TRG) com Ereni Rodrigues. Atendimento para todo o Brasil. Agende sua sessão.",
      },
      { name: "author", content: "Ereni Rodrigues" },
      {
        property: "og:title",
        content: "Ereni Rodrigues — Terapeuta de Reprocessamento Generativo",
      },
      {
        property: "og:description",
        content:
          "Se livre das dores que você não causou. Terapia online TRG para todo o Brasil.",
      },
